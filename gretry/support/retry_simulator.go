...
type RetrySimulator struct {
	...
	// 重试策略
	RtyPolicy gretry.RtyPolicy
}

func NewRetrySimulator(backoffPolicy backoff.SleepingBackOffPolicy, rtyPolicy gretry.RtyPolicy) *RetrySimulator {
...
func (f FailingRetryCallback) DoWithRetry(content gretry.RtyContext) interface{} {
