...
type RetryTemplate struct {
	...
	// RetryPolicy 重试策略
	RetryPolicy gretry.RtyPolicy

	// 重试Listener
	Listeners []gretry.RtyListener
...
func (r *RetryTemplate) Execute(callback gretry.RtyCallback) (interface{}, error) {
	return r.ExecuteWithState(callback, nil)
}

func (r *RetryTemplate) ExecuteWithRecover(callback gretry.RtyCallback, recoverCallback gretry.RecoverCallback) (interface{}, error) {
	return r.ExecuteWithRecoverAndState(callback, recoverCallback, nil)
}

func (r *RetryTemplate) ExecuteWithState(callback gretry.RtyCallback, state gretry.RtyState) (interface{}, error) {
	return r.ExecuteWithRecoverAndState(callback, nil, state)
}

func (r *RetryTemplate) ExecuteWithRecoverAndState(callback gretry.RtyCallback, recoverCallback gretry.RecoverCallback, state gretry.RtyState) (interface{}, error) {
...
func (r *RetryTemplate) doOnSuccessInterceptors(callback gretry.RtyCallback, ctx gretry.RtyContext, result interface{}) {
	for i := len(r.Listeners); i > 0; i-- {
		r.Listeners[i].OnSuccess(ctx, callback, result)
	}
}

func (r *RetryTemplate) doCloseInterceptors(callback gretry.RtyCallback, ctx gretry.RtyContext, err error) {
	for i := len(r.Listeners); i > 0; i-- {
...
func (r *RetryTemplate) close(rtyPolicy gretry.RtyPolicy, ctx gretry.RtyContext, state gretry.RtyState, succeeded bool) {
	if state != nil {
		if succeeded {
			...
			rtyPolicy.Close(ctx)
			ctx.SetAttribute(gretry.Closed, true)
		}
	} else {
		rtyPolicy.Close(ctx)
		ctx.SetAttribute(gretry.Closed, true)
...
func (r *RetryTemplate) handleRetryExhausted(callback gretry.RecoverCallback, ctx gretry.RtyContext, state gretry.RtyState) (interface{}, error) {
	ctx.SetAttribute(gretry.Exhausted, true)
	if state != nil && !ctx.HasAttribute(GlobalState) {
		r.RetryContextCache.Remove(state.GetKey())
	}
	if callback != nil {
		var recovered = callback.Recover(ctx)
		ctx.SetAttribute(gretry.Recovered, true)
...
func (r *RetryTemplate) shouldRethrow(rtyPolicy gretry.RtyPolicy, ctx gretry.RtyContext, state gretry.RtyState) bool {
	return state != nil && state.RollbackFor(ctx.GetLastError())
}

func (r *RetryTemplate) doOnErrorInterceptors(callback gretry.RtyCallback, ctx gretry.RtyContext, err error) {
	for i := len(r.Listeners); i > 0; i-- {
...
func (r *RetryTemplate) canRetry(rtyPolicy gretry.RtyPolicy, ctx gretry.RtyContext) bool {
	return rtyPolicy.CanRetry(ctx)
}

func (r *RetryTemplate) registerError(rtyPolicy gretry.RtyPolicy, state gretry.RtyState, ctx gretry.RtyContext, err error) error {
	rtyPolicy.RegisterError(ctx, err)
	return r.RegisterContext(ctx, state)
}

func (r *RetryTemplate) RegisterContext(ctx gretry.RtyContext, state gretry.RtyState) error {
	if state != nil {
...
func (r *RetryTemplate) doOpenInterceptors(callback gretry.RtyCallback, ctx gretry.RtyContext) bool {
	var result = true
...
func (r *RetryTemplate) open(rtyPolicy gretry.RtyPolicy, state gretry.RtyState) gretry.RtyContext {
	if state == nil {
...
func (r *RetryTemplate) doOpenInternalWithoutState(rtyPolicy gretry.RtyPolicy) gretry.RtyContext {
	return r.doOpenInternal(rtyPolicy, nil)
}

func (r *RetryTemplate) doOpenInternal(rtyPolicy gretry.RtyPolicy, state gretry.RtyState) gretry.RtyContext {
	// TODO 未完全上线
