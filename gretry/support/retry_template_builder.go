...
type RetryTemplateBuilder struct {
	// 重试策略
	BaseRtyPolicy gretry.RtyPolicy
	// 回退策略
...
func (e *RetryTemplateBuilder) CustomPolicyRtyPolicy(rtyPolicy gretry.RtyPolicy) *RetryTemplateBuilder {
	if e.BaseRtyPolicy != nil {
		panic("You have already selected backoff policy")
	}
...
// WithListener 增加监听
func (e *RetryTemplateBuilder) WithListener(listener gretry.RtyListener) *RetryTemplateBuilder {
	e.Listeners = append(e.Listeners, listener)
	return e
}

// WithListeners 增加监听
func (e *RetryTemplateBuilder) WithListeners(listeners []gretry.RtyListener) *RetryTemplateBuilder {
...
func (e *RetryTemplateBuilder) Build() *RetryTemplate {
	...
	finalPolicy.SetPolicies([]gretry.RtyPolicy{e.BaseRtyPolicy, policy.ErrorClassifierRetryPolicy{ErrorClassifier: errClassifier}})
...
func (e *RetryTemplateBuilder) ListenersList() []gretry.RtyListener {
	return e.Listeners
}
