...
func (t *TimeoutRtyPolicy) CanRetry(ctx gretry.RtyContext) bool {
	return (ctx.(*TimeoutRtyContext)).IsAlive()
}

func (t *TimeoutRtyPolicy) Open(parent gretry.RtyContext) gretry.RtyContext {
	return NewTimeoutRtyContext(parent, t.Timeout)
}

func (t *TimeoutRtyPolicy) Close(ctx gretry.RtyContext) {
	// no-op
}

func (t *TimeoutRtyPolicy) RegisterError(ctx gretry.RtyContext, err error) {
...
func NewTimeoutRtyContext(parent gretry.RtyContext, timeout int64) *TimeoutRtyContext {
